...
const UserProfile = React.lazy( () => import('../containers/Freelancer/EditFreelancerProfile/FreelancerProfile') );
...
const routes = [
  ...
  { path: '/freelancer/profile', exact: true, name: 'Freelancer Profile', component: UserProfile },
];
