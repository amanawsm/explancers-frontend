...
import classes from "./FreelancerPublicProfile.module.css";
import { connect } from 'react-redux';
import { getFreelancerProfile } from 'state/actions';
import Spinner from 'components/UI/Spinner/Spinner';
import { Badge, Card, CardHeader, CardBody, CardText, FormGroup, Form, Row, Col } from "reactstrap";
...
class FreelancerPublicProfile extends Component {
  ...
  componentWillMount() {
    ...
    this.setState({ queryUserName: username })
    this.props.onGetFreelancerProfile(username);
  }
  ...
  render() {
    ...
    if (this.props.formData) {
        ...
        <Fragment>
          ...
          <Col md="12" sm="12" lg="12" xs="12">
            <Row>
                ...
                <Card className="card-user">
                  <CardBody>
                    ...
                    <div className={"author " + classes.Author}>
                      <UserAvatar className="avatar" username={this.state.queryUserName}></UserAvatar>
              ...
              {this.props.formData["education"] && this.props.formData["education"].length ? <Col md="12">
                <Card>
                  <CardHeader>
      ...
      content = <NoResultFoundForList message={"No Freelancers Found in the Market With This Criteria"}></NoResultFoundForList>
    }
...
export default connect(mapPropsToState, mapDispatchToState)(FreelancerPublicProfile);